...
<html lang="en">
<head>
<title>The Clothify Store | SignUp Page |</title>  
<meta charset="utf-8">
...
<div class="container" style="padding-top: 1.3rem; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
  <div class="wrapper">
    <div id="auth" class="authentication">
      <div class="wrapper">
        <div id="register" class="card active">
          <div class="wrapper" style="box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.25);">
            <!-- Left Form Section -->
            <div class="animation form signup">
              <div class="wrapper">
                <h3 class="title" style="text-align: left;">Sign Up</h3>

                <form method="POST">
                  <div class="form-group input">
                    <label for="user-username">Username:</label>
                    <input type="text" id="user-username" class="user-email" name="username" required />
                  </div>

                  <div class="form-group input">
                    <label for="user-password">Password:</label>
                    <input type="password" id="user-password" class="user-password" name="password" required />
                  </div>

                  <button type="submit" class="button color-1 signup">Sign Up</button>
                </form>
            ...
            <!-- Right Note Section -->
            <div class="animation note signup">
              <div class="wrapper">
                <h1 class="head1">Let's Get Started!</h1>
                <p>Join us and start your journey now!</p>
                <p>Already a member? Login to explore more!</p>
              </div>
            </div>
          </div>
        </div>
