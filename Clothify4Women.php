...
<html lang="en">
<head>
<title>The Clothify Store | Womens Fashion |</title>  
<meta charset="utf-8">
...
<body>
<!-- Java Script -->
<script src="javascript/Clothify4All.js" async></script>
    ...
    <div class="cursos__container">
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion1.jpg" class="imagen__curso">

          <div class="info__card">
            <img src="img/estrellas.png">
            <p><span class="precio">&#8377 1000</span> <span class="discount">&#8377 499</span>  </p>
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion2.jpg" class="imagen__curso">

          <div class="info__card">
            <img src="img/estrellas.png">
            <p><span class="precio">&#8377 1200</span> <span class="discount">&#8377 699</span>  </p>
            <a href="#" class="agregar-carrito" data-id="2"><i class="fa fa-shopping-bag"></i>&nbsp;  ADD TO BAG</a>
          </div>
        </div>
      </div>
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion3.jpg" class="imagen__curso">

          <div class="info__card">
            <img src="img/estrellas.png">
            <p><span class="precio">&#8377 1199</span> <span class="discount">&#8377   599</span>  </p>
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion4.jpg" class="imagen__curso">

          <div class="info__card">
            <img src="img/estrellas.png">
            <p><span class="precio">&#8377 2000</span> <span class="discount">&#8377  1499</span>  </p>
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion5.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion6.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion7.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion8.jpg" class="imagen__curso">

          <div class="info__card">
            <img src="img/estrellas.png">
            <p><span class="precio">&#8377 1190</span> <span class="discount">&#8377 800</span>  </p>
            <a href="#" class="agregar-carrito"  data-id="8"><i class="fa fa-shopping-bag"></i>&nbsp;  ADD TO BAG</a>
          </div>
        </div> <!--.card-->
      </div>
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion9.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion10.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion11.jpg" class="imagen__curso">
      ...
      <div class="curso__item">
        <div class="curso__card">
          <img src="img/WomenFashion12.jpg" class="imagen__curso">
